...
CUDA_DECL double gsl_log1p (const double x);
CUDA_DECL double gsl_expm1 (const double x);
double gsl_hypot (const double x, const double y);
double gsl_hypot3 (const double x, const double y, const double z);
CUDA_DECL double gsl_acosh (const double x);
CUDA_DECL double gsl_asinh (const double x);
CUDA_DECL double gsl_atanh (const double x);
