 ...
 */
CUDA_DECL int gsl_sf_sin_e(double x, gsl_sf_result * result);
CUDA_DECL double gsl_sf_sin(const double x);


/* Cos(x) with GSL semantics.
 */
CUDA_DECL int gsl_sf_cos_e(double x, gsl_sf_result * result);
CUDA_DECL double gsl_sf_cos(const double x);
 ...
 */
CUDA_DECL int gsl_sf_sin_err_e(const double x, const double dx, gsl_sf_result * result);


/* Cos(x) for quantity with an associated error.
 */
CUDA_DECL int gsl_sf_cos_err_e(const double x, const double dx, gsl_sf_result * result);
