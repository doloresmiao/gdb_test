 ...
 */
CUDA_DECL int gsl_sf_airy_Ai_e(const double x, const gsl_mode_t mode, gsl_sf_result * result);
CUDA_DECL double gsl_sf_airy_Ai(const double x, gsl_mode_t mode);
 ...
 */
CUDA_DECL int gsl_sf_airy_Bi_e(const double x, gsl_mode_t mode, gsl_sf_result * result);
CUDA_DECL double gsl_sf_airy_Bi(const double x, gsl_mode_t mode);
 ...
 * exceptions: none
 */
CUDA_DECL int gsl_sf_airy_Ai_scaled_e(const double x, gsl_mode_t mode, gsl_sf_result * result);
CUDA_DECL double gsl_sf_airy_Ai_scaled(const double x, gsl_mode_t mode);
 ...
 * exceptions: none
 */
CUDA_DECL int gsl_sf_airy_Bi_scaled_e(const double x, gsl_mode_t mode, gsl_sf_result * result);
CUDA_DECL double gsl_sf_airy_Bi_scaled(const double x, gsl_mode_t mode);
