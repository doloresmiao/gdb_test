 ...
 */
CUDA_DECL static double ai_data_f[9] = {
...
CUDA_DECL static cheb_series aif_cs = {
  ai_data_f,
  8,
  -1, 1,
  8
...
CUDA_DECL static double ai_data_g[8] = {
   0.01815236558116127,
   0.02157256316601076,
   0.00025678356987483,
   0.00000142652141197,
...
CUDA_DECL static cheb_series aig_cs = {
  ai_data_g,
  7,
  -1, 1,
  7
...
/* chebyshev for Ai(x) asymptotic factor 
 ...
 original usage...
*/
CUDA_DECL static double data_aip[36] = {
...
CUDA_DECL static cheb_series aip_cs = {
  data_aip,
  35,
  -1, 1,
  17
